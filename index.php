<?php
$error_string='Please enter details to log in.';
  if($_SERVER["REQUEST_METHOD"]=="POST"){
    include 'config.php';
    $email=$_POST['email'];
    $pwd=$_POST['password'];
    $query="SELECT * FROM userdata WHERE email='$email' && password='$pwd' ";
    ...
    if($rows==1){
      ...
      $error_string= "Login Failed!..Enter correct details.";
    }
  }
  ...
  <body>
    ...
    <main class="LoginContainer" >
      <form action="#" method="POST" class="form_main" autocomplete="off">
        ...
        <a class="forgotLink" href="forgetpwd.php">Forgot your password?</a>
